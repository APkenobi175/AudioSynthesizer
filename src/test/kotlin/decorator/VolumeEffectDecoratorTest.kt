...
class VolumeEffectDecoratorTest {
    ...
    fun testScalesByLevel() {
        ...
        val decorated = VolumeEffectDecorator(ConstantOnesStrategy(), 0.8)
    ...
    fun testNoClamping() {
        ...
        val decorated = VolumeEffectDecorator(ConstantOnesStrategy(), 2.0)
        val samples = decorated.generate(440.0, 44100, 100)
    ...
    fun testZeroLevel() {
        ...
        val decorated = VolumeEffectDecorator(ConstantOnesStrategy(), 0.0)
        val samples = decorated.generate(440.0, 44100, 100)
        for (n in samples.indices) {
    ...
    fun testChaining() {
        ...
        val chained = VolumeEffectDecorator(VolumeEffectDecorator(ConstantOnesStrategy(), 0.5), 0.5)
