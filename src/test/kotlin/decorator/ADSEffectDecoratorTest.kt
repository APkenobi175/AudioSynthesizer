...
class ADSEffectDecoratorTest {
    ...
    fun testStartsAtZero(){
        val decorated = ADSEffectDecorator(ConstantStrategy(1.0), 0.02, 0.5, 0.6)
    ...
    fun testZeroAttack(){
        val decorated = ADSEffectDecorator(ConstantStrategy(1.0), 0.0, 0.5, 0.6)
    ...
    fun testZeroDecay(){
        val decorated = ADSEffectDecorator(ConstantStrategy(1.0), 0.5, 0.5, 0.6)
